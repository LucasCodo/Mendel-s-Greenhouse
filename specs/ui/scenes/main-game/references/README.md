---
title: Main Game References
tags:
  - ui/scenes/main-game/reference
...
Place scene reference images in this folder.

Current visual target:

```text
main-game-layout-target.png
```

Component image references:

- `components/main-game-component-top-bar.png`
- `components/main-game-component-contract-banner.png`
